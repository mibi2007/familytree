...
func (r *TokenRepository) Create(ctx context.Context, token *domain.SecureToken) error {
	query := `
...
func (r *TokenRepository) Get(ctx context.Context, tokenStr string) (*domain.SecureToken, error) {
	query := `
