...
extension AuthFailurePatterns<T> on AuthFailure<T> {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(IdAlreadyUsed<T> value)? idAlreadyUsed,
    ...
    TResult Function(UserNotFound<T> value)? userNotFound,
    TResult Function(LimitExceededException<T> value)? limitExceededException,
    TResult Function(InvalidParam<T> value)? invalidParam,
    TResult Function(CustomTokenMismatch<T> value)? customTokenMismatch,
    TResult Function(InvalidCustomToken<T> value)? invalidCustomToken,
    TResult Function(EmailAlreadyConfirmed<T> value)? emailAlreadyConfirmed,
    TResult Function(MissingEmail<T> value)? missingEmail,
    TResult Function(InvalidToken<T> value)? invalidToken,
    TResult Function(ExpiredToken<T> value)? expiredToken,
    TResult Function(AccountExistsWithDifferentCredential<T> value)? accountExistsWithDifferentCredential,
    TResult Function(PluginNotInitialized<T> value)? pluginNotInitialized,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case CancelByUser() when cancelByUser != null:
        return cancelByUser(_that);
      case AuthServerError() when serverError != null:
        return serverError(_that);
      case EmailAlreadyUsed() when emailAlreadyUsed != null:
        return emailAlreadyUsed(_that);
      case IdAlreadyUsed() when idAlreadyUsed != null:
        return idAlreadyUsed(_that);
      case InvalidEmailPassword() when invalidEmailPassword != null:
        return invalidEmailPassword(_that);
      case InvalidEmail() when invalidEmail != null:
        return invalidEmail(_that);
      case InvalidPhone() when invalidPhone != null:
        return invalidPhone(_that);
      case InvalidPassword() when invalidPassword != null:
      ...
      case LimitExceededException() when limitExceededException != null:
        return limitExceededException(_that);
      case InvalidParam() when invalidParam != null:
        return invalidParam(_that);
      case CustomTokenMismatch() when customTokenMismatch != null:
        return customTokenMismatch(_that);
      case InvalidCustomToken() when invalidCustomToken != null:
        return invalidCustomToken(_that);
      case EmailAlreadyConfirmed() when emailAlreadyConfirmed != null:
        return emailAlreadyConfirmed(_that);
      case MissingEmail() when missingEmail != null:
        return missingEmail(_that);
      case InvalidToken() when invalidToken != null:
        return invalidToken(_that);
      case ExpiredToken() when expiredToken != null:
        return expiredToken(_that);
      case AccountExistsWithDifferentCredential() when accountExistsWithDifferentCredential != null:
        return accountExistsWithDifferentCredential(_that);
      case PluginNotInitialized() when pluginNotInitialized != null:
        return pluginNotInitialized(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(IdAlreadyUsed<T> value) idAlreadyUsed,
    required TResult Function(InvalidEmailPassword<T> value) invalidEmailPassword,
    ...
    required TResult Function(UserNotFound<T> value) userNotFound,
    required TResult Function(LimitExceededException<T> value) limitExceededException,
    required TResult Function(InvalidParam<T> value) invalidParam,
    required TResult Function(CustomTokenMismatch<T> value) customTokenMismatch,
    required TResult Function(InvalidCustomToken<T> value) invalidCustomToken,
    required TResult Function(EmailAlreadyConfirmed<T> value) emailAlreadyConfirmed,
    required TResult Function(MissingEmail<T> value) missingEmail,
    required TResult Function(InvalidToken<T> value) invalidToken,
    required TResult Function(ExpiredToken<T> value) expiredToken,
    required TResult Function(AccountExistsWithDifferentCredential<T> value) accountExistsWithDifferentCredential,
    required TResult Function(PluginNotInitialized<T> value) pluginNotInitialized,
  }) {
    final _that = this;
    switch (_that) {
      case CancelByUser():
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function()? idAlreadyUsed,
    ...
    TResult Function(String param)? customTokenMismatch,
    TResult Function(String param)? invalidCustomToken,
    TResult Function()? emailAlreadyConfirmed,
    TResult Function()? missingEmail,
    TResult Function()? invalidToken,
    TResult Function()? expiredToken,
    TResult Function(String email)? accountExistsWithDifferentCredential,
    TResult Function(String provider)? pluginNotInitialized,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case InvalidParam() when invalidParam != null:
        return invalidParam(_that.param);
      case CustomTokenMismatch() when customTokenMismatch != null:
        return customTokenMismatch(_that.param);
      case InvalidCustomToken() when invalidCustomToken != null:
        return invalidCustomToken(_that.param);
      case EmailAlreadyConfirmed() when emailAlreadyConfirmed != null:
      ...
      case ExpiredToken() when expiredToken != null:
        return expiredToken();
      case AccountExistsWithDifferentCredential() when accountExistsWithDifferentCredential != null:
        return accountExistsWithDifferentCredential(_that.email);
      case PluginNotInitialized() when pluginNotInitialized != null:
        return pluginNotInitialized(_that.provider);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function() idAlreadyUsed,
    ...
    required TResult Function(String param) customTokenMismatch,
    required TResult Function(String param) invalidCustomToken,
    required TResult Function() emailAlreadyConfirmed,
    required TResult Function() missingEmail,
    required TResult Function() invalidToken,
    required TResult Function() expiredToken,
    required TResult Function(String email) accountExistsWithDifferentCredential,
    required TResult Function(String provider) pluginNotInitialized,
  }) {
    final _that = this;
    switch (_that) {
      case CancelByUser():
...
class InvalidParam<T> implements AuthFailure<T> {
  ...
  $InvalidParamCopyWith<T, InvalidParam<T>> get copyWith =>
      _$InvalidParamCopyWithImpl<T, InvalidParam<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InvalidParam<T> &&
...
abstract mixin class $InvalidParamCopyWith<T, $Res> implements $AuthFailureCopyWith<T, $Res> {
  factory $InvalidParamCopyWith(InvalidParam<T> value, $Res Function(InvalidParam<T>) _then) =
      _$InvalidParamCopyWithImpl;
  @useResult
  $Res call({String param});
}

/// @nodoc
class _$InvalidParamCopyWithImpl<T, $Res> implements $InvalidParamCopyWith<T, $Res> {
...
class CustomTokenMismatch<T> implements AuthFailure<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CustomTokenMismatchCopyWith<T, CustomTokenMismatch<T>> get copyWith =>
      _$CustomTokenMismatchCopyWithImpl<T, CustomTokenMismatch<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CustomTokenMismatch<T> &&
            (identical(other.param, param) || other.param == param));
  }
...
abstract mixin class $CustomTokenMismatchCopyWith<T, $Res> implements $AuthFailureCopyWith<T, $Res> {
  factory $CustomTokenMismatchCopyWith(CustomTokenMismatch<T> value, $Res Function(CustomTokenMismatch<T>) _then) =
      _$CustomTokenMismatchCopyWithImpl;
  @useResult
  $Res call({String param});
}

/// @nodoc
class _$CustomTokenMismatchCopyWithImpl<T, $Res> implements $CustomTokenMismatchCopyWith<T, $Res> {
...
class InvalidCustomToken<T> implements AuthFailure<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $InvalidCustomTokenCopyWith<T, InvalidCustomToken<T>> get copyWith =>
      _$InvalidCustomTokenCopyWithImpl<T, InvalidCustomToken<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InvalidCustomToken<T> &&
            (identical(other.param, param) || other.param == param));
  }
...
abstract mixin class $InvalidCustomTokenCopyWith<T, $Res> implements $AuthFailureCopyWith<T, $Res> {
  factory $InvalidCustomTokenCopyWith(InvalidCustomToken<T> value, $Res Function(InvalidCustomToken<T>) _then) =
      _$InvalidCustomTokenCopyWithImpl;
  @useResult
  $Res call({String param});
}

/// @nodoc
class _$InvalidCustomTokenCopyWithImpl<T, $Res> implements $InvalidCustomTokenCopyWith<T, $Res> {
...
class AccountExistsWithDifferentCredential<T> implements AuthFailure<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AccountExistsWithDifferentCredentialCopyWith<T, AccountExistsWithDifferentCredential<T>> get copyWith =>
      _$AccountExistsWithDifferentCredentialCopyWithImpl<T, AccountExistsWithDifferentCredential<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AccountExistsWithDifferentCredential<T> &&
...
abstract mixin class $AccountExistsWithDifferentCredentialCopyWith<T, $Res> implements $AuthFailureCopyWith<T, $Res> {
  factory $AccountExistsWithDifferentCredentialCopyWith(
          AccountExistsWithDifferentCredential<T> value, $Res Function(AccountExistsWithDifferentCredential<T>) _then) =
...
class PluginNotInitialized<T> implements AuthFailure<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PluginNotInitializedCopyWith<T, PluginNotInitialized<T>> get copyWith =>
      _$PluginNotInitializedCopyWithImpl<T, PluginNotInitialized<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PluginNotInitialized<T> &&
...
abstract mixin class $PluginNotInitializedCopyWith<T, $Res> implements $AuthFailureCopyWith<T, $Res> {
  factory $PluginNotInitializedCopyWith(PluginNotInitialized<T> value, $Res Function(PluginNotInitialized<T>) _then) =
      _$PluginNotInitializedCopyWithImpl;
  @useResult
  $Res call({String provider});
}

/// @nodoc
class _$PluginNotInitializedCopyWithImpl<T, $Res> implements $PluginNotInitializedCopyWith<T, $Res> {
