...
@ProviderFor(systemClient)
final systemClientProvider = SystemClientProvider._();

final class SystemClientProvider
    extends
        $FunctionalProvider<
          SystemServiceClient,
          SystemServiceClient,
          SystemServiceClient
        >
    with $Provider<SystemServiceClient> {
  SystemClientProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'systemClientProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$systemClientHash();

  @$internal
  @override
  $ProviderElement<SystemServiceClient> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  SystemServiceClient create(Ref ref) {
    return systemClient(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(SystemServiceClient value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<SystemServiceClient>(value),
    );
  }
}

String _$systemClientHash() => r'ae36cc541f85a4c3e2caefcdacabfb100c1181a3';
