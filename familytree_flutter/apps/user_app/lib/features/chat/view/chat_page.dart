...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    streamMessages(widget.familyId);
  }
  ...
  void _sendMessage() {
    ...
    sendMessage(widget.familyId, content);
...
class _MessageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Watch((context) {
      final currentUser = authUserSignal.value.map(data: (user) => user, loading: () => null, error: (_, __) => null);
