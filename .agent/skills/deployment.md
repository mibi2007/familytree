...
- **Infrastructure**: Hosted on a dedicated Virtual Machine (VM).
- **Management**: **Caddy** is used for easier network management, TLS termination, and potentially as a reverse proxy for the database service.
